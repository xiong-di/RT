...
parser.add_argument('--refer-path', type=str, default="./json_csv_files/ks50_test_refer.json")
parser.add_argument('--video-path', type=str, default="./Kinetics400/K50-clipped/image_mulframe_val256_k=50")
parser.add_argument('--audio-path', type=str, default="./Kinetics400/K50-clipped/audio_val256_k=50")
parser.add_argument('--save-path', type=str, default="./json_csv_files/ks50")
