...
parser.add_argument('--clean-path', type=str, default='./json_csv_files/vgg/clean/severity_0.json')
parser.add_argument('--video-c-path', type=str, default="./VGGSound/image_mulframe_test-C")
parser.add_argument('--audio-path', type=str, default="./VGGSound/audio_test")
