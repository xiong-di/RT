...
def data_stas():
    ...
    # Draw a bar chart of the number of instances in each category
    ...
    plt.savefig('./vis_results/stat.png')
...
def plot_scatter(data, save_name, all_acc):
    ...
    # Reorganize the data into two lists, one to store batch_idx and the other to store all predicted classes
    batch_idx = []
    predicted_classes = []
